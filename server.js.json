...
function faceOriginGuard(req,res,next){ const origin=req.get('origin'); if(origin && !ALLOWED_ORIGINS.includes(origin)) return res.status(403).json({erro:'Origem não autorizada'}); next(); }
